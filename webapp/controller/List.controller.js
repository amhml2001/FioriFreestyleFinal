sap.ui.define([
    ...
    return BaseController.extend("moovi.zrxnamandaapp.controller.List", {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "moovi.zrxnamandaapp.view.ViewSettingsDialog",
                    controller: this
        ...
        onBtnCreatePress: function (oEvent) {
            ...
            if (!this.oDialogEditCompany) {
                this.oDialogEditCompany = Fragment.load({
                    id: this.getView().getId(),
                    name: "moovi.zrxnamandaapp.view.EditCompanyDialog",
                    controller: this
                }).then(function (oDialog) {
