		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#moovizrxnamandaapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"moovizrxnamandaapp-display": {
								"semanticObject": "moovizrxnamandaapp",
								"action": "display",
								"description": "ListDetail Fiori Freestyle",
								"title": "Companhias Aéreas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=moovi.zrxnamandaapp",
									"url": sap.ui.require.toUrl("moovi/zrxnamandaapp")
								}
							}
						}
					}
